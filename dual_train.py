...
def train(args, train_loader, val_loader, test_loader, optim_r2p, optim_p2r, model_r2p, model_p2r, loss_fn):
...
def main(args):
    ...
    train_loader, val_loader, test_loader, rna_dims, pro_dims = util.get_dataset(args)
    ...
    train(args, train_loader, val_loader, test_loader, optim_r2p, optim_p2r, model_r2p, model_p2r, loss_fn)
